...
{
    public class BuildPlotPowerOnEquipProcessor : SimpleGameEntityProcessor<BuildPlotPowerComponent, PowerReceiverComponent, PlayerControllerComponent>
    {
        public BuildPlotPowerOnEquipProcessor() : base()
        {
            ...
            foreach (var kvp in ComponentDatas)
            {
                ...
                if(powerComp.IsEquipping)
                {
                    ...
                    if (itemData.IsVaild())
                    {
                        ...
                        cmd.AddEntityComponent<BuildPlotComponent>(entity, comp =>
                        {
