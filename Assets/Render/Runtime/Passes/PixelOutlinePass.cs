...
namespace Lost.Render.Runtime
{
    public class PixelOutlinePass : ScriptableRenderPass
    {
        ...
        private RenderTargetHandle tempDepthTex;
        ...
        public PixelOutlinePass(PixelOutline _setting)
        {
            ...
            tempDepthTex.Init("_TempDepthTex");
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            depthDes.sRGB = false;
            cmd.GetTemporaryRT(tempDepthTex.id, depthDes, FilterMode.Point);
        }       
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.SetGlobalTexture(ShaderConstant._DepthTex, tempDepthTex.id);
        ...
        public override void FrameCleanup(CommandBuffer cmd)
        {
            ...
            cmd.ReleaseTemporaryRT(tempDepthTex.id);
        }
    }
}
