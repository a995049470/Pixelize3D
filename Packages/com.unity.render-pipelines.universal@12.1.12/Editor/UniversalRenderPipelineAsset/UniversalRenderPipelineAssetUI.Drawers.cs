...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
...
#endif
            , CED.FoldoutGroup(Styles.customSettingsText, Expandable.Custom, k_ExpandedState, CED.Group(DrawCustom))
        );
        ...
        static void DrawQuality(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            serialized.targetScreenHeight.intValue = EditorGUILayout.IntSlider(Styles.targetScreenHeight, serialized.targetScreenHeight.intValue, 1, 1080);
        ...
        static void DrawCustom(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            EditorGUILayout.ObjectField(serialized.overwriteDefaultShader, Styles.overwriteDefaultShader);
        }
