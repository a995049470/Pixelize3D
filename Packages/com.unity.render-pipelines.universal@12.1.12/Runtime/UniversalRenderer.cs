...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        //在renderFeatrue中是否存在直接blit到rendertarget的pass
        private bool isHasCustomFinalBlitPassInRenderFeatures = false;
        ...
        private void CheckHasCustomFinalBlitPassInRenderFeatures()
        {
            isHasCustomFinalBlitPassInRenderFeatures = false;
            foreach (var rendererFeature in rendererFeatures)
            {
                if(rendererFeature is IFinalBlitRenderFeature finalBlit && finalBlit.IsActiveFinalBlitRenderFeature())
                {
                    isHasCustomFinalBlitPassInRenderFeatures = true;
                    break;
                }
            }
        }
        ...
        {
            CheckHasCustomFinalBlitPassInRenderFeatures();
            ...
            if (lastCameraInTheStack)
            {
                ...
                if (!cameraTargetResolved && !isHasCustomFinalBlitPassInRenderFeatures)
                {
