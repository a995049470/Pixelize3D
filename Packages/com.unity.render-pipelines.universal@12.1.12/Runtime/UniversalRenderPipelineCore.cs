...
namespace UnityEngine.Rendering.Universal
{
    ...
    public struct CameraData
    {
        ...
        public Matrix4x4 GetGPUProjectionMatrix(bool renderIntoTexture)
        {
            return GL.GetGPUProjectionMatrix(GetProjectionMatrix(0), renderIntoTexture);
        }
    ...
    internal static class ShaderPropertyId
    {
        ...
        public static readonly int _VaildSSAOTexture = Shader.PropertyToID("_VaildSSAOTexture");
    }
