...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] int m_TargetScreenHeight = 1080;
...
#endif
        [SerializeField] Shader overwriteDefaultShader;
        ...
        public float renderScale
        {
            get
            {
                float scale = (float)m_TargetScreenHeight / Mathf.Max(1, Screen.height);
                scale = UnityEngine.Mathf.Clamp(scale, UniversalRenderPipeline.minRenderScale, UniversalRenderPipeline.maxRenderScale);
                return scale;
            }
        ...
        public override Shader defaultShader
        {
            get
            {
                ...
                if(overwriteDefaultShader != null)
                {
                    return overwriteDefaultShader;
                } 
