    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                {
                    Matrix4x4 view;
                    if(!LostRenderPipelineSetting.TryGet("_MatrixV_AlignedPixel", out view))
                    {
                        view = renderingData.cameraData.GetViewMatrix(eyeIndex);
                    }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                using (new ProfilingScope(cmd, m_ProfilingSampler))
                {
                    ...
                    cmd.SetGlobalInt(ShaderPropertyId._VaildSSAOTexture, 1);
            ...
            public override void OnCameraCleanup(CommandBuffer cmd)
            {
                ...
                cmd.SetGlobalInt(ShaderPropertyId._VaildSSAOTexture, 0);
